...
/* 
 * examples of usage :
 * $myPacker = new MinifyJS($script, 62, true, false);
 * $packed = $myPacker->pack();
 * 
 * or
 * 
 * $myPacker = new MinifyJS($script, 'Normal', true, false);
 * $packed = $myPacker->pack();
 * 
 * or (default values)
 * 
 * $myPacker = new MinifyJs($script);
 * $packed = $myPacker->pack();
 */
...
class MinifyJs {
	...
	private function _bootStrap($packed, $keywords) {
		...
		$unpackPacker = new MinifyJS($unpack, 0, false, true);
